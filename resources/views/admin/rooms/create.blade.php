...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">الرئيسية - إضافة الغرفة</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/dashboard">الرئيسية</a></li>
                        <li class="breadcrumb-item active">إضافة الغرفة</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <form role="form" method='post' action="{{ route('rooms.store') }}" enctype="multipart/form-data">
                    ...
                    <!-- Room Name -->
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required name="capacity" value="{{ old('capacity') }}"
                                   class="form-control"/>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required name="available_count" value="{{ old('available_count') }}"
                                   class="form-control"/>
                        </div>

                        <!-- Area -->
                        <div class="form-group">
                            <label for="area">مساحه الغرفه</label>
                            <input type="text" required name="area" value="{{ old('area') }}" class="form-control"/>
                        </div>
                        <!-- Description -->
                        <div class="form-group">
