const Plugins = [
  ...
  {
    from: 'dist/css',
    to  : 'docs/old_assets/css'
  },
  {
    from: 'dist/js',
    to  : 'docs/old_assets/js'
  },
  // jQuery
  {
    from: 'node_modules/jquery/dist',
    to  : 'docs/old_assets/plugins/jquery'
  },
  // Popper
  {
    from: 'node_modules/popper.js/dist',
    to  : 'docs/old_assets/plugins/popper'
  },
  // Bootstrap
  {
    from: 'node_modules/bootstrap/dist/js',
    to  : 'docs/old_assets/plugins/bootstrap/js'
  },
  // Font Awesome
  {
    from: 'node_modules/@fortawesome/fontawesome-free/css',
    to  : 'docs/old_assets/plugins/fontawesome-free/css'
  },
  {
    from: 'node_modules/@fortawesome/fontawesome-free/webfonts',
    to  : 'docs/old_assets/plugins/fontawesome-free/webfonts'
  },
  // overlayScrollbars
  {
    from: 'node_modules/overlayscrollbars/js',
    to  : 'docs/old_assets/plugins/overlayScrollbars/js'
  },
  {
    from: 'node_modules/overlayscrollbars/css',
    to  : 'docs/old_assets/plugins/overlayScrollbars/css'
  }
]
